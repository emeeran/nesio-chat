...
if "max_tokens" not in st.session_state:
    st.session_state.max_tokens = 950
    ...
    try:
        response = await client.chat.completions.create(
            ...
            messages=[
                ...
                {"role": "user", "content": f"Summarize the following {content_type} content:\n{content}"},
            ],
            max_tokens=450,
...
system_messages_with_custom = list(system_messages.keys()) + ["Custom"]
